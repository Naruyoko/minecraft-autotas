...
public abstract class AbstractXYZPlayer extends AbstractXZPlayer {
  ...
  public XYZBoundingBox boundingBox; // {net.minecraft.entity.Entity.boundingBox}
  public double posY; // {net.minecraft.entity.Entity.posZ}
  public double velY; // {net.minecraft.entity.Entity.motionY}

  public AbstractXYZPlayer(XYZBoundingBox boundingBox, double posX, double posY, double posZ, double velX, double velY,
      double velZ, float yaw) {
  ...
  public AbstractXYZPlayer(double posX, double posY, double posZ, double velX, double velY, double velZ, float yaw) {
    ...
    this.boundingBox = new XYZBoundingBox(posX - (double)halfWidth, posY, posZ - (double)halfWidth,
        posX + (double)halfWidth, posY + (double)height, posZ + (double)halfWidth);
  }

  public AbstractXYZPlayer() { this(0, 0, 0, 0, 0, 0, 0); }
  ...
  public static void copy(AbstractXYZPlayer target, AbstractXYZPlayer source) {
    ...
    XYZBoundingBox.copy(target.boundingBox, source.boundingBox);
