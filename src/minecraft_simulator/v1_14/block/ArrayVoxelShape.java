...
/**
 * See {net.minecraft.util.shape.VoxelShape} and
 * {net.minecraft.util.shape.ArrayVoxelShape}
 * 
 * A container of VoxelSet that specifies where the cells are divided using
 * lists
 */
public class ArrayVoxelShape {
   ...
   */
  protected double getCoord(Direction.Axis axis, int i) { return this.getIncludedPoints(axis)[i]; }
   ...
   */
  protected double[] getIncludedPoints(Direction.Axis axis) {
    switch (axis) {
    case X:
      return this.xPoints;
    case Y:
